                    ...
                    <tr style="width: 100%">
                        <td style="width: 100%" valign="middle">
                            ...
                            <cc1:ModalPopupExtender ID="ModalPopupMethod" runat="server" BackgroundCssClass="modalBackground"
                                            ...
                                            <asp:Panel ID="pnlMethod" runat="server" style="width:55%; display: none">
                            ...
                            <asp:Panel ID="purchasePanel" runat="server" Style="width: 62%; display: none">
                                                                    ...
                                                                    <cc1:TabContainer ID="tabs2" runat="server" Width="100%"  CssClass="fancy fancy-green">
                                                                        <cc1:TabPanel ID="tabMaster" runat="server" HeaderText="Purchase Details" >
                                                                            ...
                                                                            <ContentTemplate>
                                                                                            ...
                                                                                            <table width="810px" cellpadding="0" cellspacing="1">
                                                                                                <%--<tr>
                                                                                               ...
                                                                                               <tr>
                                                                                                            ...
                                                                                                            <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                                                                                                                ...
                                                                                                                <ContentTemplate>
                                                                                                                    <asp:DropDownList ID="cmbSupplier" runat="server" AppendDataBoundItems="true" AutoCompleteMode="Suggest"
                                                                                                                        AutoPostBack="true" DataTextField="LedgerName" DataValueField="LedgerID" Width="100%" CssClass="drpDownListMedium" BackColor = "#e7e7e7" 
                                                                                                                        ValidationGroup="purchaseval" OnSelectedIndexChanged="cmbSupplier_SelectedIndexChanged" style="border: 1px solid #e7e7e7" height="26px">
                                                                                                ...
                                                                                                <tr>
                                                                                                     <td class="ControlLabel" style="width: 25%;" valign="middle">Address1 </td>
                                                                                                     <td class="ControlTextBox3" style="width: 24%;">
                                                                                                     ...
                                                                                                     <td style="width: 5%;"></td>
                                                                                                     <td class="ControlLabel" style="width: 15%;">Address2 </td>
                                                                                                     <td class="ControlTextBox3" style="width: 24%">
                                                                                                ...
                                                                                                <tr>
                                                                                                     ...
                                                                                                     <td style="width: 5%;"></td>
                                                                                                     <td class="ControlLabel" style="width: 15%;">Address3 </td>
                                                                                                     <td class="ControlTextBox3" style="width: 24%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td  style="width: 24%" class="ControlTextBox3">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtdisc" runat="server" AutoPostBack="True" OnTextChanged="txtdisc_TextChanged" CssClass="cssTextBox" ValidationGroup="product" Text="0"  Width="100%" BackColor = "#e7e7e7" 
                                                                                                            ></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td  style="width: 20%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 24%" class="ControlTextBox3">
                                                                                                        <asp:TextBox ID="txtdiscamt" runat="server" AutoPostBack="True" OnTextChanged="txtdiscamt_TextChanged" CssClass="cssTextBox" ValidationGroup="product" Text="0"  Width="100%" BackColor = "#e7e7e7" 
                                                                                                            ></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td style="width:5%;">
                                                                                                    ...
                                                                                                    <td style="width: 24%" class="ControlTextBox3">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtfixedtotal" runat="server" CssClass="cssTextBox" ValidationGroup="product" Text="0"  Width="100%" BackColor = "#e7e7e7" 
                                                                                                            ></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td  style="width: 20%">
                                                                                                            ...
                                                                                                            <ContentTemplate>
                                                                                                                <asp:Panel ID="pnlBank" runat="server" Visible="false">
                                                                                                                    <table cellpadding="0" cellspacing="1" width="100%">
                                                                                                                        <tr>
                                                                                                                           <td class="ControlLabel" style="width: 25%">
                                                                                                                               <asp:RequiredFieldValidator ID="rvCheque" runat="server" ControlToValidate="txtChequeNo" 
                                                                                                                                    EnableClientScript="true" Enabled="false" ErrorMessage="Cheque No. is mandatory"
                                                                                                                                    Text="*" ValidationGroup="purchaseval" />
                                                                                                                                Cheque / Credit Card No.*
                                                                                                                            </td>
                                                                                                                            <td class="ControlTextBox3"  style="width:24%;">
                                                                                                                                <%--<asp:Panel ID="Panel20" runat="server" Width="100px">--%>
                                                                                                                                    <asp:TextBox ID="txtChequeNo" runat="server" CssClass="cssTextBox" Width="80%" BackColor = "#e7e7e7" 
                                                                                                                            ...
                                                                                                                            <td class="ControlLabel" style="width:15%;">
                                                                                                                                <asp:RequiredFieldValidator ID="rvbank" runat="server" ControlToValidate="cmbBankName"
                                                                                                                                    CssClass="lblFont" EnableClientScript="true" Enabled="false" ErrorMessage="Bank is mandatory"
                                                                                                                                    InitialValue="0" Text="*" ValidationGroup="purchaseval" />
                                                                                                                                Bank name *
                                                                                                                            </td>
                                                                                                                            <td  class="ControlDrpBorder"  style="width:24%;">
                                                                                                                                <%--<asp:Panel ID="Panel21" runat="server" Width="20%">--%>
                                                                                                                                    <asp:DropDownList ID="cmbBankName" runat="server" AppendDataBoundItems="true" AutoCompleteMode="Suggest" style="border: 1px solid #e7e7e7" height="26px"
                                                                                                                                        AutoPostBack="False" DataTextField="LedgerName" DataValueField="LedgerID" Width="100%" CssClass="drpDownListMedium" BackColor = "#e7e7e7" 
                                                                        ...
                                                                        <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Product Details" >
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <table width="810px" cellpadding="1" cellspacing="1">
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    <table style="border: 0px solid #5078B3" cellpadding="3" cellspacing="2"
                                                                                                                                        ...
                                                                                                                                        <tr id="rowBarcode" runat="server">
                                                                                                                                            <td id="Td1" runat="server" class="ControlLabel" style="width: 17%">
                                                                                                                                                Barcode
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    <table style="width: 100%; border: 0px solid #5078B3;" cellpadding="3" cellspacing="2">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td  class="ControlTextBox3" style="width: 25%">
                                                                                                                                                 <asp:TextBox ID="lblCSTAdd" runat="server" CssClass="cssTextBox" Text="0" Width="100%" ValidationGroup="product"  BackColor = "#e7e7e7"  Height="23px"
                                                                                                                                                        ></asp:TextBox>
                                                                                                            ...
                                                                                                            <ContentTemplate>
                                                                                                                <table width="100%">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td class="uploadingbg312" style="text-align: left;">
                                                                                                                            <div>
                                                                                                                                <div>
                                                                                                                                    <%--<div>--%>
                                                                                                                                        <table border="0" cellpadding="0px" cellspacing="5px" style="margin: 0px auto;">
                                                                                                                                            ...
                                                                                                                                            <tr >
                                                                                                                                                ...
                                                                                                                                                <td align="right">
                                                                                                                                                    <asp:Label ID="lblTotalVAT" runat="server" CssClass="item2" Font-Bold="true"></asp:Label>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr style="display: none">
                                                                                                                                                <td align="left">
                                                                        ...
                                                                        <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="Additional Details">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <table class="tblLeft" width="810px" cellpadding="0" cellspacing="1">
                                                                                    <tr>
                                                                                        <td style="width: 20%" class="ControlLabel">
                                                                                            Voucher No. *
                                                                                        </td>
                                                                                        <td class="ControlTextBox3"  style="width: 23%">
                                                                                            <asp:Label ID="txtInvoiveNo" runat="server" height="30px" BackColor = "#e7e7e7" 
                                                                                                        ></asp:Label>
                                                                                        </td>
                                                                                            ...
                                                                                            <asp:UpdatePanel ID="UpdatePanel1" RenderMode="Inline" runat="server" UpdateMode="Conditional">
                                                                                                ...
                                                                                                <ContentTemplate>
                                                                                                    <table runat="server" id="rowdcnum" cellpadding="0" cellspacing="0" width="100%"
                                                                                                        >
                                                                                                        <tr>
                                                                                                            <td style="width: 19.7%" class="ControlLabel">
                                                        ...
                                                        <tr style=" border-color:white">
                                                            ...
                                                            <td style=" border-color:white">
                                                                <asp:DropDownList ID="ddlPageSelector" OnSelectedIndexChanged="ddlPageSelector_SelectedIndexChanged"
                                                                    runat="server" AutoPostBack="true" BackColor="#BBCAFB"  Width="70px" Height="24px" style="border:1px solid blue">
                                                                </asp:DropDownList>
                                                            </td>
