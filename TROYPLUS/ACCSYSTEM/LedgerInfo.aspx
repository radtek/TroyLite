<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="LedgerInfo.aspx.cs" Inherits="LedgerInfo" Title="Accounts > Ledger Information" %>
                ...
                <tr style="width: 100%">
                    <td style="width: 100%">
                        ...
                        <asp:Panel runat="server" ID="popUp" Style="width: 56%">
                            <div id="contentPopUp">
                                <table class="tblLeft" cellpadding="2" cellspacing="2" style="border: 0px solid #5078B3;
                                                        ...
                                                        <table cellpadding="1" cellspacing="1" style="border: 1px solid #86b2d1; width: 100%;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ControlNumberBox3" style="width:20%">
                                                                    ...
                                                                    <asp:DropDownList ID="ddCRDRAdd" runat="server" Enabled="false" style="border: 1px solid #e7e7e7" height="26px" Width="55px" CssClass="drpDownListMedium" BackColor = "#e7e7e7" SelectedValue='<%# Bind("DRORCR") %>'>
                                                                        <asp:ListItem Text="CR" Value="CR"></asp:ListItem>
                                                                        <asp:ListItem Text="DR" Value="DR"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </td>
