                                                                                                                                                        ...
                                                                                                                                                        <FooterStyle CssClass="dataRow" />--%>
                                                                                                                                                            ...
                                                                                                                                                            <Columns>
                                                                                                                                                                ...
                                                                                                                                                                <asp:TemplateField HeaderText="Product Code-Name-Model" ItemStyle-Width="1px" ItemStyle-Font-Size="15px" HeaderStyle-ForeColor="Black">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:DropDownList ID="drpPrd" Width="200px" runat="server" AppendDataBoundItems="true" BackColor="White" ForeColor="#0567AE" Font-Bold="true" AutoPostBack="true" CssClass="chzn-select" DataTextField="ProductName" DataValueField="ItemCode" OnSelectedIndexChanged="drpPrd_SelectedIndexChanged">
                                                                                                                                                                        </asp:DropDownList>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                ...
                                                                                                                                                                <asp:TemplateField HeaderText="Employee Name" ItemStyle-Width="200px" ItemStyle-Font-Size="15px" HeaderStyle-ForeColor="Black">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:DropDownList ID="drpIncharge" Width="200px" runat="server" AppendDataBoundItems="true" BackColor="White" ForeColor="#0567AE" Font-Bold="true" AutoPostBack="true" CssClass="chzn-select" DataTextField="empFirstName" DataValueField="empno" OnSelectedIndexChanged="drpIncharge_SelectedIndexChanged">
                                                                                                                                                                        </asp:DropDownList>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
