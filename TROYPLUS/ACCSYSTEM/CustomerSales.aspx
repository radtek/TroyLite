                                                                                                                                                    ...
                                                                                                                                                    <div style="height: 250px; width: 100%; overflow: scroll">
                                                                                                                                                        ...
                                                                                                                                                        <FooterStyle CssClass="dataRow" />--%>
                                                                                                                                                            ...
                                                                                                                                                            <Columns>
                                                                                                                                                                ...
                                                                                                                                                                <asp:TemplateField HeaderText="Rate with VAT" ItemStyle-Width="50px" ItemStyle-Font-Size="15px" HeaderStyle-ForeColor="Black">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtRtVAT" Style="text-align: right" runat="server" ReadOnly="true" Width="50px" ForeColor="#0567AE" Font-Bold="true"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
