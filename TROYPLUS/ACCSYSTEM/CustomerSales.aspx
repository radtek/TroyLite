                                                                                                                                                ...
                                                                                                                                                <td colspan="4">
                                                                                                                                                    <div style="height: 250px; width: 100%; overflow: scroll">
                                                                                                                                                        ...
                                                                                                                                                        <FooterStyle CssClass="dataRow" />--%>
                                                                                                                                                            ...
                                                                                                                                                            <Columns>
                                                                                                                                                                <asp:BoundField DataField="RowNumber" HeaderText="SNo" ItemStyle-Width="45px" />
                                                                                                                                                                <asp:TemplateField HeaderText="Product Code-Name-Model" ItemStyle-Width="1px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:DropDownList ID="drpPrd" Width="200px" runat="server" AppendDataBoundItems="true" BackColor="#e7e7e7" AutoPostBack="true" CssClass="chzn-select" DataTextField="ProductName" DataValueField="ItemCode" OnSelectedIndexChanged="drpPrd_SelectedIndexChanged">
                                                                                                                                                                        </asp:DropDownList>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtQty" Style="text-align: right" runat="server" Width="50px" AutoPostBack="true" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Employee Name" ItemStyle-Width="1px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:DropDownList ID="drpIncharge" Width="200px" runat="server" AppendDataBoundItems="true" BackColor="#e7e7e7" AutoPostBack="true" CssClass="chzn-select" DataTextField="empFirstName" DataValueField="empno" OnSelectedIndexChanged="drpIncharge_SelectedIndexChanged">
                                                                                                                                                                        </asp:DropDownList>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Description" ItemStyle-Width="0.2px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtDesc" runat="server" ReadOnly="true" Width="150px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Rate" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtRate" Style="text-align: right" runat="server" ReadOnly="true" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Stock" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        ...
                                                                                                                                                                        <asp:TextBox ID="txtStock" Style="text-align: right" ReadOnly="true" runat="server" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Exec Commission" ItemStyle-Width="0.1px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtExeComm" Style="text-align: right" runat="server" ReadOnly="true" Width="55px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Disc(%)" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtDisPre" Style="text-align: right" runat="server" Width="50px" ReadOnly="true" AutoPostBack="true" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="VAT(%)" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtVATPre" Style="text-align: right" ReadOnly="true" runat="server" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="CST(%)" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtCSTPre" Style="text-align: right" runat="server" ReadOnly="true" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="VAT Amount" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtVATAmt" Style="text-align: right" runat="server" ReadOnly="true" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Rate with VAT" ItemStyle-Width="0.3px">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtRtVAT" Style="text-align: right" runat="server" ReadOnly="true" Width="50px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                                </asp:TemplateField>
                                                                                                                                                                <asp:TemplateField HeaderText="Row Total" ItemStyle-Width="0.2px" HeaderStyle-HorizontalAlign="Left">
                                                                                                                                                                    <ItemTemplate>
                                                                                                                                                                        <asp:TextBox ID="txtTotal" Style="text-align: right" runat="server" ReadOnly="true" Width="65px"></asp:TextBox>
                                                                                                                                                                    </ItemTemplate>
                                                                                                                                                    ...
                                                                                                                                                    <asp:Panel ID="Panel7" runat="server">
                                                                                                                                                        <table style="width: 100%;">
                                                                                                                                                            <tr>
                                                                                                                                                                ...
                                                                                                                                                                <td style="width: 20%;" class="ControlLabelproject">Freight                                                                                                                                                               
                                                                                                                                                                <td style="width: 20%;">
                                                                                                                                                                 <asp:TextBox ID="txtFreight"  Style="text-align: right" runat="server" AutoPostBack="True" BorderWidth="1px" OnTextChanged="txtQty_TextChanged" SkinID="skinTxtBox" TabIndex="6" Text="0" ValidationGroup="product" Width="200px"></asp:TextBox>
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td style="width: 60%;"></td>
                                                                                                                                                                <td style="width: 20%;" class="ControlLabelproject">Loading / Unloading                                                                                                                                                                
                                                                                                                                                                <td style="width: 20%;">
                                                                                                                                                                  <asp:TextBox ID="txtLU" Style="text-align: right" runat="server" AutoPostBack="True" BorderWidth="1px" OnTextChanged="txtQty_TextChanged" SkinID="skinTxtBox" TabIndex="7" Text="0" ValidationGroup="product" Width="200px"></asp:TextBox>
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td style="width: 60%;"></td>
                                                                                                                                                                <td style="width: 20%;" class="ControlLabelproject">Grand Total(INR)   
                                                                                                                                                                <td style="width: 20%;">
