<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="UserOptions.aspx.cs" Inherits="UserOptions" Title="Security > Users Lock" %>
        ...
        <tr style="width: 100%">
            <td style="width: 100%">
                ...
                <div class="mainConBody">
                    ...
                    <asp:Panel ID="purchasePanel" runat="server" Style="width: 78%; display: none">
                                                            ...
                                                            <table cellpadding="2" cellspacing="2"
                                                                ...
                                                                <tr>
                                                                    <td  colspan="5">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td class="ControlLabel" style="width: 28%">
                                                                                        ...
                                                                                        <rwg:BulkEditGridView ID="GridREPORT" AutoGenerateColumns="False" BorderWidth="1px"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:BoundField DataField="Section" HeaderText="Section" ReadOnly="true" ApplyFormatInEditMode="false" HeaderStyle-BorderColor="Gray" HeaderStyle-Wrap="false" />
                                                                                                    ...
                                                                                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderStyle-Width="60px" HeaderText="Add" HeaderStyle-BorderColor="Gray">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:CheckBox ID="chkboxAdd" runat="server" style="color: Black" Text="" Font-Names="arial" Font-Size="11px" Checked='<%# Bind("Add") %>' Enabled="False">
                                                                                                            </asp:CheckBox>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderStyle-Width="60px" HeaderText="Edit" HeaderStyle-BorderColor="Gray">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:CheckBox ID="chkboxEdit" runat="server" style="color: Black" Text="" Font-Names="arial" Font-Size="11px" Checked='<%# Bind("Edit") %>' Enabled="False">
                                                                                                            </asp:CheckBox>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderStyle-Width="60px" HeaderText="Delete" HeaderStyle-BorderColor="Gray">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:CheckBox ID="chkboxDel" runat="server" style="color: Black" Text="" Font-Names="arial" Font-Size="11px" Checked='<%# Bind("Delete") %>' Enabled="False">
                                                                                                            </asp:CheckBox>
                                                                                                         </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderStyle-Width="60px" HeaderText="View" HeaderStyle-BorderColor="Gray">
                                                                                        ...
                                                                                        <rwg:BulkEditGridView ID="GridConfig" AutoGenerateColumns="False" BorderWidth="1px"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:BoundField DataField="Section" HeaderText="Section" ReadOnly="true" ApplyFormatInEditMode="false" HeaderStyle-BorderColor="Gray" HeaderStyle-Wrap="false" />
                                                                                                    ...
                                                                                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderStyle-Width="60px" HeaderText="View" HeaderStyle-BorderColor="Gray">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:CheckBox ID="chkboxView" runat="server" style="color: Black" Text="" Font-Names="arial" Font-Size="11px" Checked='<%# Bind("Views") %>' Enabled="False">
                                                                                                            </asp:CheckBox>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                </Columns>
                                        ...
                                        <PagerTemplate>
                                            <table style=" border-color:white">
                                                <tr style=" border-color:white">
                                                    ...
                                                    <td style=" border-color:white">
                                                        <asp:DropDownList ID="ddlPageSelector" runat="server" AutoPostBack="true" Width="65px" style="border:1px solid blue" BackColor="#BBCAFB" Height="23px">
                                                        </asp:DropDownList>
                                                    </td>
