                            ...
                            <div class="mainConBody">
                                <table style="width: 100.3%;margin: -3px 0px 0px 2px;" cellpadding="3" cellspacing="2" class="searchbg" >
                                    <tr style="height: 25px; vertical-align: middle">
                                        ...
                                        <td style="width: 10%; color: #000080;" align="right">
                                            Search
                                        ...
                                        <td style="width: 20%" class="Box1">
                                            <div style="width: 150px; font-family: 'Trebuchet MS';">
                                                <asp:DropDownList ID="ddCriteria" runat="server"  Width="156px" BackColor="#BBCAFB" Height="23px" style="text-align:center;border:1px solid #BBCAFB ">
                                                        ...
                                                        <table cellpadding="1" cellspacing="1" style="border: 1px solid #86b2d1; width: 100%;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" style="width:25%" class="ControlDrpBorder">
                                                                    <asp:DropDownList ID="ComboBox2" runat="server" AutoPostBack="False" Width="100%" CssClass="drpDownListMedium" BackColor = "#90c9fc"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" style="width:25%" class="ControlDrpBorder">
                                                                    <asp:DropDownList ID="ComboBox2Add" runat="server" Width="100%" CssClass="drpDownListMedium" BackColor = "#90c9fc" AutoPostBack="False"
                                                                        ...
                                                                        <asp:ListItem style="background-color: #90c9fc" Text="Select Ledger" Value="0"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td>
                                                                </td>
                    ...
                    <table width="100%" style="margin: -6px 0px 0px 0px;">
                        ...
                        <div class="mainGridHold" id="searchGrid">
                            <asp:GridView ID="GrdViewNote" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                OnRowCreated="GrdViewNote_RowCreated" Width="100.3%" DataSourceID="GridSource"
