        ...
        <ContentTemplate>
            ...
            <td style="width: 100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="width: 82%" class="ControlTextBox66">
                                                                                                    <asp:TextBox ID="txtProjectDesc" runat="server" TabIndex="12"
                                                                                                         style="overflow: hidden;padding: 0px;font-family: 'Trebuchet MS'; font-size: 13px; background-color:#90c9fc" Width="99%" height="100px" TextMode="MultiLine"/>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                ...
                <asp:GridView ID="GrdWME" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center" Width="100.7%" CssClass="someClass"
