        ...
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (txtTaskUpdateDate.Text.Trim() != string.Empty)
                    TaskUpdateDate = txtTaskUpdateDate.Text.Trim();
                if (txtActualStartDate.Text.Trim() != string.Empty)
                    ActualStartDate = txtActualStartDate.Text.Trim();
            ...
            if (dsd != null)
            {
                if (dsd.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (dsd.Tables[0].Rows[0]["Actual_End_Date"] != null)
                        txtActualEndDate.Text = Convert.ToDateTime(dsd.Tables[0].Rows[0]["Actual_End_Date"]).ToString("dd/MM/yyyy");
