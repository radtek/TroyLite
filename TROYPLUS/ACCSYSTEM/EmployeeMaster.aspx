<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="EmployeeMaster.aspx.cs" Inherits="EmployeeMaster" Title="Others > Business Partner" EnableEventValidation="false" %>
                                                                                        ...
                                                                                        <td style="width: 20%">
                                                                                            ...
                                                                                            EnableTheming="false" SkinID="skinBtnCancel" OnClick="CancelRolePayMapBtn_Click">
                                                                                             ...
                                                                                             <asp:Button ID="AssignRolePayMapBtn" Text="Assign" runat="server" CausesValidation="False" CommandName="AssignRolePay"
                                                                                                EnableTheming="false" SkinID="skinBtnCancel" OnClick="AssignRolePayMapBtn_Click">
                                                                                                </asp:Button>                                                                                          
                                                                                        </td>
                                                                                        <td style="width: 20%"> 
