<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="~/GroupInfo.aspx.cs" Inherits="GroupInfo" Title="Accounts > Group Information" %>
                                                    ...
                                                    <EditItemTemplate>
                                                        <div class="divArea" align="center">
                                                            <table cellpadding="1" cellspacing="1" style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td class="ControlLabel" style="width:33%">
                                                                        Group Name
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="center" style="width:30%">
                                                                                    <asp:Button ID="InsertButton" runat="server" SkinID="skinBtnSave" CausesValidation="True"
                                                                                        CssClass="savebutton1231" EnableTheming="false" CommandName="Insert" OnClick="InsertButton_Click">
                                                                                    </asp:Button>
                                                                                </td>
                                                                                <td align="center" style="width:30%">
