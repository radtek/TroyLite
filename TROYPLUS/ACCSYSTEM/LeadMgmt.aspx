                                ...
                                <div>
                                    <table cellspacing="2px" cellpadding="0" border="0" width="99.8%"  style="margin: -2px 0px 0px 1px;"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5%; color: White;" align="right">
                                                Search
                                            </td>
                                                                                ...
                                                                                <div>
                                                                                    <table style="width: 770px; border: 0px solid #86b2d1" align="center" cellpadding="0" cellspacing="2">
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            <td class="ControlLabel" style="width: 23%;">
                                                                                                Lead Name *
                                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLeadName"
                                                                                                    ErrorMessage="Lead Name is mandatory" Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                            </td>
                                                                                            ...
                                                                                            <td class="ControlLabel" style="width: 18%;">
                                                                                                BP Name *
                                                                                                <%--<asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="cmbCustomer"
                                                                                            ...
                                                                                            <td class="ControlDrpBorder" style="width: 22%;">
                                                                                                ...
                                                                                                <asp:TextBox ID="txtBPName" runat="server" TabIndex="4" SkinID="skinTxtBoxGrid" Visible="false" ></asp:TextBox>
                                                                                            </td>
                                                                                            <td style="width: 10%;">
                                                                                                <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:CheckBox runat="server" ID="chk" Text="Existing" OnCheckedChanged="chk_CheckedChanged" AutoPostBack="true"/>
                                                                                                    </ContentTemplate>
                                                                                                </asp:UpdatePanel>
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            ...
                                                                                            <td class="ControlTextBox3" style="width: 22%;">
                                                                                                <asp:TextBox ID="txtTelephone" runat="server" TabIndex="7" SkinID="skinTxtBoxGrid"></asp:TextBox>
                                                                                            </td>
                                                                                            <td style="width: 10%;">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="ControlDrpBorder" style="width: 18%;">
                                                                                                <asp:DropDownList ID="drpIncharge" TabIndex="8" Enabled="True" EnableTheming="false" AppendDataBoundItems="true" CssClass="drpDownListMedium"
                                                                                            ...
                                                                                            <td class="ControlLabel" style="width: 18%;">
                                                                                                <asp:CompareValidator ID="cvModeOfContact" runat="server" ControlToValidate="drpStatus"
                                                                                                    Display="Dynamic" ErrorMessage="Please Select Doc Status" Operator="GreaterThan"
                                                                                                    Text="*" ValueToCompare="0"></asp:CompareValidator>
                                                                                                Doc Status *
                                                                                            </td>
                                                                                            <td class="ControlDrpBorder" style="width: 22%;">
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            <td class="ControlLabel" style="width: 23%;">
                                                                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTotalAmount"
                                                                                                    Display="Dynamic" ErrorMessage="Total Amount Invoiced is mandatory.">*</asp:RequiredFieldValidator>--%>
                                                                                                Total Amount Invoiced
                                                                                            </td>
                                                                                            <td class="ControlTextBox3" style="width: 22%;">
                                                                                                <asp:TextBox ID="txtTotalAmount" runat="server" TabIndex="10" SkinID="skinTxtBoxGrid" Enabled="false"></asp:TextBox>
                                                                                            </td>
                                                                                            <td  class="ControlLabel" style="width: 18%;">
                                                                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtClosingDate"
                                                                                                    Display="Dynamic" ErrorMessage="Closing Date is mandatory.">*</asp:RequiredFieldValidator>--%>
                                                                                                Closing Date
                                                                                            </td>
                                                                                            <td class="ControlTextBox3" style="width: 22%">
                                                                                                <asp:TextBox ID="txtClosingDate" runat="server" TabIndex="11" SkinID="skinTxtBoxGrid" Enabled="false"></asp:TextBox>
                                                                                            </td>
                                                                                            <td style="width: 10%;">
                                                                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Animated="true" Format="dd/MM/yyyy"
                                                                                                    PopupButtonID="ImageButton1" PopupPosition="BottomLeft" TargetControlID="txtClosingDate">
                                                                                                </cc1:CalendarExtender>
                                                                                                <asp:ImageButton ID="ImageButton1" ImageUrl="App_Themes/NewTheme/images/cal.gif" Visible="false"
                                                                                                                                    CausesValidation="False" Width="20px" runat="server" />  
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height: 2px">
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            <td class="ControlLabel" style="width: 23%;">
                                                                                                Branch *
                                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtBranch"
                                                                                                    Display="Dynamic" ErrorMessage="Branch is mandatory.">*</asp:RequiredFieldValidator>
                                                                                            </td>
                                                                                            <td class="ControlDrpBorder" style="width: 22%">
                                                                                                <asp:TextBox ID="txtBranch" runat="server" TabIndex="12" Enabled="false" SkinID="skinTxtBoxGrid"></asp:TextBox>
                                                                                            </td>
                                                                                            <td  class="ControlLabel" style="width: 18%;">
                                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtClosingPer"
                                                                                                    Display="Dynamic" ErrorMessage="Closing Date is mandatory.">*</asp:RequiredFieldValidator>
                                                                                                Closing % *
                                                                                            </td>
                                                                                            <td class="ControlDrpBorder" style="width: 22%">
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            <td class="ControlLabel" style="width: 23%;">
                                                                                                <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="drpLeadStatus"
                                                                                                    Display="Dynamic" ErrorMessage="Please Select Lead Status" Operator="GreaterThan"
                                                                                                    Text="*" ValueToCompare="0"></asp:CompareValidator>
                                                                                                Lead Status *
                                                                                            </td>
                                                                                            <td class="ControlDrpBorder" style="width: 22%">
                                                                                                <asp:DropDownList ID="drpLeadStatus" TabIndex="14" Enabled="True" EnableTheming="false" AppendDataBoundItems="true" CssClass="drpDownListMedium"
